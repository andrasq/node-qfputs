...
module.exports = (function() {
    ...
    function Fputs( writable, opts ) {
        ...
        // expose FileWriter.renameFile
        // FIXME: set to a function that returns an error if renameFile not available
        if (writable._isFileWriter) this.renameFile = writable.renameFile;
    }

    // export FileWriter on the Fputs class
    Fputs.FileWriter = FileWriter;

    // export renameFile as a QFputs class method as well
