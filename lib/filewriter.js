...
if (!fse) {
    console.warn("qfputs: fs-ext not installed, appending lines without flock");
    fse = {
...
function _tryRequire(name) { return eval("try { require('" + name + "') } catch (e) { }") }
...
var allocBuf = eval('process.versions.node >= 7 ? Buffer.allocUnsafe : Buffer');
