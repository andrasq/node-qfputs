...
function FileWriter( filename, openmode ) {
    ...
    // expose class method on instance
    this.mutexTimeout = FileWriter.mutexTimeout;
    this.renameFile = FileWriter.renameFile;
}


// rename the file and wait for write activity to cease
FileWriter.mutexTimeout = 5000;
FileWriter.renameFile = function renameFile( oldName, newName, waitMs, cb ) {
    ...
    var fd = null, mutexTimeout = (this && this != global) ? this.mutexTimeout : FileWriter.mutexTimeout;
